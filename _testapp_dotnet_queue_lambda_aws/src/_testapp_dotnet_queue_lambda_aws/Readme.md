...
Execute unit tests
```
    cd "_testapp_dotnet_queue_lambda_aws/test/_testapp_dotnet_queue_lambda_aws.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "_testapp_dotnet_queue_lambda_aws/src/_testapp_dotnet_queue_lambda_aws"
